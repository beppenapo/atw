...
<html lang="it">
  ...
  <body>
    ...
    <main class="container pt-5 mt-5">
      <form class="form bg-white py-5 px-3 border rounded shadow" id="formModContatto">
        <input type="hidden" class="form-control" name="id" value="<?php echo $_POST['id']; ?>">
        <div class="form-row">
          <div class="col border-bottom mb-3">
            <h4 class="d-block m-0">Modifica i dati di <span id="nomeContatto"></span></h4>
        ...
        <div class="form-row mb-3">
          <div class="col-md-3 mb-3 mb-sm-3 mb-md-0">
        ...
        <div class="form-row mb-3">
          <div class="col-md-6 mb-3 mb-sm-3 mb-md-0">
    ...
    <script src="js/modContatto.js" charset="utf-8"></script>
  </body>
</html>
