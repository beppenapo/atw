...
<html lang="it">
  ...
  <body>
    ...
    <main class="container pt-5 mt-5">
      <form class="form bg-white pt-2 pb-5 px-3 border rounded shadow" id="formCampione">
        <div class="form-row">
          <div class="col border-bottom mb-3 text-center">
            <h2><?php echo $_POST['cantiere']; ?></h2>
            <h4 class="d-block m-0">Aggiorna campione</h4>
        ...
        <div class="form-row mb-3">
          ...
          <div class="col-md-4 divTipologia">
        ...
        <div class="form-row mb-3">
          <div class="col">
            <label for="descrizione">Descrizione campione</label>
    ...
    <script src="js/editCampione.js" charset="utf-8"></script>
  </body>
</html>
